...
module FinanceApp {
        ...
        WebAPI: WebAPIService)
    {
        ...
        // incomes
        WebAPI.getIncomes().then(r => {
            $scope.incomeCat = r.data;
        });
        // expenses
        WebAPI.getExpenses().then(r => {
            $scope.expenseCat = r.data;
        });
        // accounts
        WebAPI.getAccounts().then(r => {
        ...
        var options: ITransactionOptions = {
            date: null,
            //type: null,
            amount: null,
            categoryId: null,
        ...
        function getTransactions() {
            ...
            WebAPI.getTransactions(options).then(r => {
        ...
        $scope.sort = function (field: string) {
