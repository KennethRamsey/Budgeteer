...
module FinanceApp {
    ...
    function graph(authSvc: AuthService, WebAPI: WebAPIService) {
        return {
            ...
            link: function (scope, elem: JQuery) {
                ...
                function getMonthSums() {
                    return WebAPI.getMonthSums().then(r => {
                        scope.sums = r.data;
                        ...
                        for (var j: number = 0; j < scope.expenses.length; j++) {
                ...
                function generateGraph() {
                    ...
                    getMonthSums().then(() => {
                        ...
                        function xAxisLabelGenerator(index: number) {
                        ...
                        chartOptions = {
                            ...
                            yaxis: {
                                tickFormatter: function (num: number) { return '$ ' + num; }
                            },
                            bars: {
                                show: true,
                                barWidth: .25, // because the x axis is in inc's of 1, .2 is good.
                                fill: true,
                                lineWidth: 0,
                                order: true,
                        ...
                        if (holder.length) {
                            ...
                            (<any>$).plot(holder, data, chartOptions);
